...
const Footer = () => {
  return (
    <div className='h-screen w-full bg-black'>
        <div className='grid grid-rows-2 lg:grid-cols-2 gap-4 p-20 h-[70%]'>   
           ...
           <div className='flex justify-center items-left flex-col h-full mt-9 lg:mt-0'>
                  <p className='text-2xl text-gray-300 text-left lg:text-center pb-10'>FIND ME</p>
                  <div className='flex justify-center items-center text-gray-300 text-2xl	lg:text-4xl'>
